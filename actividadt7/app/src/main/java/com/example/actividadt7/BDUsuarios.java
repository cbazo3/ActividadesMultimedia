...
public class BDUsuarios extends SQLiteOpenHelper
{
    ...
    private final String SQLCREATE = "CREATE TABLE Usuarios (codigo INTEGER, nombre TEXT, apellido TEXT)";
     ...
     */
    public void insertarUsuario(int codigo, String nombre, String apellido) throws Exception
    {
        ...
        try
        {
            ...
            if( c.getCount() > 0 )
            {
                do
                {
                    ...
                    usuarios.add(new Usuario(codigo, nombre, apellido));
                } while (c.moveToNext());
            }
